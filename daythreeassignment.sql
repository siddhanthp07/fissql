...
--16
select Ename,DATEDIFF(year,Hiredate,SYSDATETIME())/365,count(Ename) from Emp where (DATEDIFF(year,Hiredate,SYSDATETIME())/365) BETWEEN 10 AND 20 group by Ename,Hiredate
